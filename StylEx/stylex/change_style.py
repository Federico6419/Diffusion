...
if model_to_use == "plant":
    stylex_path = "StylEx/pretrained_stylex/models/old_plant_mobilenet/model_260.pt"
    data = "StylEx/data/plant_village/all" # Plant dataset
    classifier_name = "StylEx/pretrained_stylex/trained_classifiers/mobilenet-64px-plant.pt" # Only use mobilenet for plants
    hf = h5py.File("StylEx/pretrained_stylex/precomputed_attfind_files/style_change_records_old_plants.hdf5", 'r')
    threshold_index = 101
    shift_size = 2
    ...
    stylex_path = "StylEx/pretrained_stylex/models/new_faces_gender_resnet/model_300.pt"
    data = "StylEx/data/Kaggle_FFHQ_Resized_256px/flickrfaceshq-dataset-nvidia-resized-256px/resized" # FFHQ faces dataset
    classifier_name = "StylEx/pretrained_stylex/trained_classifiers/resnet-18-64px-gender.pt"  # Use ResNet for all the gender related ones, even the one trained on mobilenet
    hf = h5py.File("StylEx/pretrained_stylex/precomputed_attfind_files/style_change_records_new_faces.hdf5", 'r')
    threshold_index = 501
    shift_size = 1
    USE_OLD_ARCHITECTURE = False
